...
const ENEMY_META = {
  ...
  hero:      { name: 'Hero',      color: '#ff6b6b', blurb: 'Uses shield to block direct fire for units behind him. Cannot block burn damage.' },
  engineer:  { name: 'Engineer',  color: '#c084fc', blurb: 'Tunnels to the dragon and plants a timed bomb.' },
  kingsguard:{ name: 'King’s Guard', color: '#ffa8a8', blurb: 'The elite guard of the king. Fast and powerful.' },
